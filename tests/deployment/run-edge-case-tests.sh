...
# Executes all edge case tests and generates summary report
...
print_header "Edge Case Test Suite"
log_info "Started at: $(date)"
log_info "Edge case tests directory: $EDGE_DIR"

if [ ! -d "$EDGE_DIR" ]; then
    log_error "Edge case tests directory not found: $EDGE_DIR"
    exit 1
fi
...
SUMMARY_FILE="$RESULTS_DIR/edge-case-test-summary-$TIMESTAMP.txt"
